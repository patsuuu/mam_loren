...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = "INSERT INTO hub_tbl(fname, mname, lname, age, address, sex, username, password, mfa, answer, user_type) VALUES('$fname','$mname','$lname','$age','$address','$sex','$username','$pass','$mfa','$answer', '$user_type')";
